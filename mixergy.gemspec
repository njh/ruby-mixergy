...
require_relative "lib/mixergy/version"

Gem::Specification.new do |spec|
  spec.name = "mixergy"
  spec.version = Mixergy::VERSION
  spec.authors = ["Nicholas J. Humfrey"]
  spec.email = ["njh@aelius.com"]

  spec.summary = "Ruby gem for controlling Mixergy hot water tanks"
  ...
  spec.metadata["source_code_uri"] = "https://github.com/njh/ruby-mixergy.git"
